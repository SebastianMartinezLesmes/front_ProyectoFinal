...
export class DocumentosEditPage implements OnInit {
  ...
  Como complemento se indica que el aprendiz tiene llamado de atención por instructor realizado anteriormente y por coordinación el día ${this.fc} de la temática de VOIP Actividad 7: taller 5 configuración de funcionalidades central pbx VoIP.
